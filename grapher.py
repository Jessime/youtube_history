...
class Grapher:
    ...
    def humanize(self, num):
        ...
        millidx = max(0, min(len(millnames) - 1, int(np.floor(0 if n == 0 else log))))
    ...
    def duration(self):
        ...
        data = [go.Histogram(x=dur, marker=dict(color="#673AB7"))]
        layout = dict(
            title="All Durations",
    ...
    def views(self):
        ...
        data = [go.Histogram(x=views, marker=dict(color="#673AB7"))]
        layout = dict(
    ...
    def make_tags_plot(self):
        ...
        layout = dict(
            title="I'm in My _____ Era.<br><br><sup>Rolling Counts of Most Popular Tag over 50 videos</sub>",
